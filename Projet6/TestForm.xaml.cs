...
{
    /// <summary>
    /// Logique d'interaction pour TestForm.xaml
    /// </summary>
    public partial class TestForm : Window
    {
        ...
        private void gagneJoueur1Button_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void TestForm_OnSetEnded(object sender, SetEndedEventArgs e)
        {
            if (e.Joueur == 1)
            {
        ...
        void TestForm_onMatchEnded(object sender, MatchEndedEventArgs e)
        {

...
namespace Projet6
{
    ...
    public class Pong
    {
        ...
        public MonRectangle Terrain { get; private set; }
        public Ligne Filet { get; private set; }
        public MonRectangle Joueur1 { get; private set; }
        public MonRectangle Joueur2 { get; private set; }
        ...
        {
            this.Terrain = new MonRectangle(this.Parent.Canvas1, (int)this.Parent.Canvas1.Width - 10, (int)this.Parent.Canvas1.Height - 10,
                new Point(5, 5), Brushes.White, new Point(0, 0), 1, Brushes.OrangeRed);
            this.Filet = new Ligne(this.Parent.Canvas1, (int)this.Parent.Canvas1.Height - 20, new Point(this.Parent.Canvas1.Width / 2, 10),
                Brushes.White, new Point(this.Parent.Canvas1.Width / 2, this.Parent.Canvas1.Height - 10), 2);
            this.Joueur1 = new MonRectangle(this.Parent.Canvas1, 5, 50, new Point(15, this.Parent.Canvas1.Height / 2),
                Brushes.White, new Point(0, 0), 1, Brushes.White);
            this.Joueur2 = new MonRectangle(this.Parent.Canvas1, 5, 50, new Point(this.Parent.Canvas1.Width - 20, this.Parent.Canvas1.Height / 2),
                Brushes.White, new Point(0, 0), 1, Brushes.White);
            this.Balle = new Cercle(this.Parent.Canvas1, 5, new Point(this.Joueur1.Centre.X + 5, this.Joueur1.Centre.Y + 20),
                Brushes.Yellow, 1, Brushes.Yellow);
            this.ScoreTexteJoueur1 = new Texte(this.Parent.Canvas1,
                this.ScoreJoueur1.Point.ToString() + " - " + this.Jeu.Score1.Point.ToString() + " - " +
                this.Set.Score1.Point.ToString() + " - " + this.Match.Score1.Point.ToString(), new Point(50, 25));
            this.ScoreTexteJoueur2 = new Texte(this.Parent.Canvas1,
                this.ScoreJoueur2.Point.ToString() + " - " + this.Jeu.Score2.Point.ToString() + " - " +
                this.Set.Score2.Point.ToString() + " - " + this.Match.Score2.Point.ToString(), new Point(this.Parent.Canvas1.Width - 200, 25));
        ...
        private void Pong_onMatchEnded(object sender, MatchEndedEventArgs e)
        {
            ...
            this.Match = new Match();
            this.CreateEnvironment();
            this.Parent.NouvellePartieMenuItem.IsEnabled = true;
            this.Parent.TerminerLaPartieMenuItem.IsEnabled = false;
            this.Parent.JoueursMenuItem.IsEnabled = true;
            this.Parent.DifficultéMenuItem.IsEnabled = true;
            ...
            if (this.Parent.ClavierMenuItem.IsChecked || this.Parent.ClavierMenuItem1.IsChecked)
                this.Parent.KeyDown -= new KeyEventHandler(this.Parent.canvas1_KeyDown);
            if (this.Parent.SourisMenuItem.IsChecked || this.Parent.SourisMenuItem1.IsChecked)
            {
                this.Parent.Canvas1.MouseDown -= new MouseButtonEventHandler(this.Parent.canvas1_MouseDown);
                this.Parent.Canvas1.MouseMove -= new MouseEventHandler(this.Parent.canvas1_MouseMove);
            }
            if (this.Parent.ManetteController.Manette1Controller.IsAlive)
